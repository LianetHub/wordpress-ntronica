 ...
 */
?>
<section class="section-about-overview" id="overview">
	<div class="container">
		<div class="row section-about-overview__layout">
			<div class="col-12 col-md-6">
				<h2 class="section-title section-about-overview__title">Company overview</h2>
			...
			<div class="col-12 col-md-6">
				<p class="section-about-overview__subtitle">Key features:</p>
